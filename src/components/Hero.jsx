...
function Hero() {
  return (
    <div className='py-8'>
        <div className='text-center grid grid-cols-1 place-items-center gap-4 '>
            ...
            <div className='grid grid-cols-2 gap-8'>
                <a className='cursor-pointer border-b-2 border-byzantine text-byzantine font-semibold py-2 px-3 rounded'>Dukung Sekarang</a>
                <a className='cursor-pointer bg-byzantine text-white font-semibold py-2 px-3 rounded'>Berikan Kesempatan</a>
            </div>
        </div>
    </div>
  )
